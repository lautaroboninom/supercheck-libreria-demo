const DEMO_STORAGE_KEY = 'supercheck_demo_state_v1';
const DEMO_MODE_KEY = 'supercheck_demo_mode';
  ...
  return [
    {
      ...
      sku_prefix: 'COCA',
      brand: 'Coca Cola',
      description: 'Gaseosa cola en botellas y packs.',
      subcategory: 'Gaseosas',
      unit_of_measure: 'unidad',
      iva_rate_pct: 21,
      usual_supplier_id: 1,
      default_price_store_ars: 1900,
      default_price_online_ars: 1900,
      default_cost_ars: 1200,
      active: true,
    },
    {
      id: 2,
      ...
      sku_prefix: 'LECHE',
      brand: 'La Serenisima',
      description: 'Leche larga vida en caja individual y packs.',
      subcategory: 'Lacteos',
      unit_of_measure: 'unidad',
      iva_rate_pct: 21,
      usual_supplier_id: 1,
      default_price_store_ars: 980,
      default_price_online_ars: 980,
      default_cost_ars: 650,
      active: true,
    },
    {
      id: 3,
      ...
      sku_prefix: 'YERBA',
      brand: 'Playadito',
      description: 'Yerba mate en paquetes de distinto peso.',
      subcategory: 'Infusiones',
      unit_of_measure: 'unidad',
      iva_rate_pct: 21,
      usual_supplier_id: 1,
      default_price_store_ars: 2600,
      default_price_online_ars: 2600,
      default_cost_ars: 1800,
      active: true,
    },
    {
      id: 4,
      ...
      sku_prefix: 'ARROZ',
      brand: 'Gallo',
      description: 'Arroz seco en paquetes y bolsa familiar.',
      subcategory: 'Secos',
      unit_of_measure: 'unidad',
      iva_rate_pct: 21,
      usual_supplier_id: 1,
      default_price_store_ars: 1350,
      default_price_online_ars: 1350,
      default_cost_ars: 900,
      active: true,
    },
    {
      id: 5,
      ...
      description: 'Productos de panaderia vendidos por peso o unidad.',
    ...
    },
    {
      ...
      sku_prefix: 'DET',
      brand: 'Magistral',
      description: 'Detergente lavavajilla en distintos envases.',
      subcategory: 'Limpieza cocina',
      unit_of_measure: 'unidad',
      iva_rate_pct: 21,
      usual_supplier_id: 1,
      default_price_store_ars: 1300,
      default_price_online_ars: 1300,
      default_cost_ars: 850,
      active: true,
    },
  ];
}
...
function baseVariants() {
  return [
    makeVariant({
      ...
      display_name: 'Botella 500ml',
      option_signature: '500ml',
      sku: 'COCA500-UN',
      barcode_internal: '7790001000079',
      price_store_ars: 750,
      price_online_ars: 750,
      cost_avg_ars: 450,
      stock_on_hand: 60,
      stock_min: 12,
      stock_max: 120,
      unit_of_measure: 'unidad',
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '500ml' }],
    }),
    makeVariant({
      id: 102,
      product_id: 1,
      producto: 'Coca Cola',
      product_name: 'Coca Cola',
      display_name: 'Botella 1.5L',
      option_signature: '1.5L',
      sku: 'COCA150-UN',
      barcode_internal: '7790001000086',
      price_store_ars: 1500,
      price_online_ars: 1500,
      cost_avg_ars: 900,
      stock_on_hand: 44,
      stock_min: 10,
      stock_max: 100,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '1.5L' }],
    }),
    makeVariant({
      id: 103,
      product_id: 1,
      producto: 'Coca Cola',
      product_name: 'Coca Cola',
      display_name: 'Botella 2.25L',
      option_signature: '2.25L',
      sku: 'COCA225-UN',
      barcode_internal: '7790001000017',
      price_store_ars: 1900,
      price_online_ars: 1900,
      cost_avg_ars: 1200,
      stock_on_hand: 36,
      stock_min: 8,
      stock_max: 80,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '2.25L' }],
    }),
    makeVariant({
      id: 104,
      product_id: 1,
      producto: 'Coca Cola',
      product_name: 'Coca Cola',
      display_name: 'Pack 6 x 2.25L',
      option_signature: 'Pack 6 x 2.25L',
      sku: 'COCA225-P6',
      barcode_internal: '7790001000093',
      price_store_ars: 10500,
      price_online_ars: 10500,
      cost_avg_ars: 7000,
      stock_on_hand: 12,
      stock_min: 3,
      stock_max: 30,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: 'Pack 6 x 2.25L' }],
    }),
    makeVariant({
      id: 201,
      product_id: 2,
      producto: 'Leche larga vida',
      product_name: 'Leche larga vida',
      display_name: 'Caja 1L',
      option_signature: '1L',
      sku: 'LECHE1-UN',
      barcode_internal: '7790001000024',
      price_store_ars: 980,
      price_online_ars: 980,
      cost_avg_ars: 650,
      stock_on_hand: 48,
      stock_min: 12,
      stock_max: 120,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '1L' }],
    }),
    makeVariant({
      id: 202,
      product_id: 2,
      producto: 'Leche larga vida',
      product_name: 'Leche larga vida',
      display_name: 'Pack 12 x 1L',
      option_signature: 'Pack 12 x 1L',
      sku: 'LECHE1-P12',
      barcode_internal: '7790001000109',
      price_store_ars: 11100,
      price_online_ars: 11100,
      cost_avg_ars: 7200,
      stock_on_hand: 8,
      stock_min: 2,
      stock_max: 20,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: 'Pack 12 x 1L' }],
    }),
    makeVariant({
      id: 301,
      product_id: 3,
      ...
      display_name: 'Paquete 500g',
      option_signature: '500g',
      sku: 'YERBA500-UN',
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '500g' }],
    }),
    makeVariant({
      id: 302,
      product_id: 3,
      producto: 'Yerba mate',
      product_name: 'Yerba mate',
      display_name: 'Paquete 1kg',
      option_signature: '1kg',
      sku: 'YERBA1-UN',
      barcode_internal: '7790001000031',
      price_store_ars: 2600,
      price_online_ars: 2600,
      cost_avg_ars: 1800,
      stock_on_hand: 30,
      stock_min: 6,
      stock_max: 60,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '1kg' }],
    }),
    makeVariant({
      id: 401,
      product_id: 4,
      producto: 'Arroz largo fino',
      product_name: 'Arroz largo fino',
      display_name: 'Paquete 500g',
      option_signature: '500g',
      sku: 'ARROZ500-UN',
      barcode_internal: '7790001000116',
      price_store_ars: 780,
      price_online_ars: 780,
      cost_avg_ars: 480,
      stock_on_hand: 35,
      stock_min: 8,
      stock_max: 90,
    ...
    makeVariant({
      ...
      price_store_ars: 1350,
      price_online_ars: 1350,
      cost_avg_ars: 900,
      stock_on_hand: 42,
      stock_min: 10,
      stock_max: 100,
    ...
    makeVariant({
      ...
      producto: 'Arroz largo fino',
      product_name: 'Arroz largo fino',
      display_name: 'Bolsa 5kg',
      option_signature: '5kg',
      sku: 'ARROZ5-UN',
      barcode_internal: '7790001000123',
      price_store_ars: 5900,
      price_online_ars: 5900,
      cost_avg_ars: 3950,
      stock_on_hand: 16,
      stock_min: 4,
      stock_max: 40,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '5kg' }],
    }),
    makeVariant({
      id: 501,
      product_id: 5,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: 'kg' }],
    }),
    makeVariant({
      id: 502,
      product_id: 5,
      producto: 'Pan',
      product_name: 'Pan',
      display_name: 'Bolsa 6 unidades',
      option_signature: 'Bolsa 6 unidades',
      sku: 'PAN-BOLSA6',
      barcode_internal: '7790001000161',
      price_store_ars: 1200,
      price_online_ars: 1200,
      cost_avg_ars: 650,
      stock_on_hand: 25,
      stock_min: 5,
      stock_max: 50,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: 'Bolsa 6 unidades' }],
    }),
    makeVariant({
      id: 601,
      product_id: 6,
    ...
    makeVariant({
      ...
      producto: 'Detergente',
      product_name: 'Detergente',
      display_name: 'Botella 750ml',
      option_signature: '750ml',
      sku: 'DET750-UN',
      barcode_internal: '7790001000062',
      price_store_ars: 1300,
      price_online_ars: 1300,
      cost_avg_ars: 850,
      stock_on_hand: 24,
      stock_min: 6,
      stock_max: 72,
      ...
      supplier_id: 1,
      supplier_name: 'Proveedor Mayorista Demo',
      option_rows: [{ attribute_code: 'presentacion', value: '750ml' }],
    }),
    makeVariant({
      id: 603,
      product_id: 6,
      ...
      option_signature: '1.5L',
      sku: 'DET1500-UN',
      barcode_internal: '7790001000154',
      price_store_ars: 2350,
      price_online_ars: 2350,
      cost_avg_ars: 1550,
      stock_on_hand: 18,
      stock_min: 6,
      stock_max: 50,
...
function baseSuppliers() {
  return [
    { id: 1, name: 'Proveedor Mayorista Demo', cuit: '30-70000001-2', phone: '011-5555-1000', email: 'compras@proveedor-demo.local', notes: 'Proveedor general', active: true },
    { id: 2, name: 'Distribuidora Lacteos Demo', cuit: '30-70000002-0', phone: '011-5555-2000', email: 'lacteos@demo.local', notes: 'Lacteos y refrigerados', active: true },
    { id: 3, name: 'Panificados Demo', cuit: '30-70000003-9', phone: '011-5555-3000', email: 'panificados@demo.local', notes: 'Entrega diaria', active: true },
  ];
}
...
function initialState() {
  const state = {
    ...
    users: [
      { id: 1, email: 'demo@supercheck.local', nombre: 'Demo Admin', rol: 'admin', activo: true },
      { id: 2, email: 'caja@supercheck.local', nombre: 'Caja Demo', rol: 'cajero', activo: true },
      { id: 3, email: 'deposito@supercheck.local', nombre: 'Deposito Demo', rol: 'repositor', activo: true },
    ],
    ...
    attributeValues: [
      { id: 1, attribute_id: 1, attribute_code: 'presentacion', value: '500ml', active: true },
      { id: 2, attribute_id: 1, attribute_code: 'presentacion', value: '1.5L', active: true },
      { id: 3, attribute_id: 1, attribute_code: 'presentacion', value: '2.25L', active: true },
      { id: 4, attribute_id: 1, attribute_code: 'presentacion', value: 'Pack 6 x 2.25L', active: true },
      { id: 5, attribute_id: 1, attribute_code: 'presentacion', value: '1L', active: true },
      { id: 6, attribute_id: 1, attribute_code: 'presentacion', value: 'Pack 12 x 1L', active: true },
      { id: 7, attribute_id: 1, attribute_code: 'presentacion', value: '500g', active: true },
      { id: 8, attribute_id: 1, attribute_code: 'presentacion', value: '1kg', active: true },
      { id: 9, attribute_id: 1, attribute_code: 'presentacion', value: '5kg', active: true },
      { id: 10, attribute_id: 1, attribute_code: 'presentacion', value: 'kg', active: true },
      { id: 11, attribute_id: 1, attribute_code: 'presentacion', value: 'Bolsa 6 unidades', active: true },
      { id: 12, attribute_id: 1, attribute_code: 'presentacion', value: '750ml', active: true },
    ],
    ...
    settings: {
      business_name: 'SuperCheck Demo',
      legal_name: 'SuperCheck Demo',
      cuit: '30-00000000-0',
      address: 'Sucursal demo',
      phone: '',
      email: '',
    ...
    pageSettings: {
      app_name: 'SuperCheck Demo',
      app_tagline: 'Demo navegable sin backend',
      footer_legal_name: 'SuperCheck Demo',
    ...
    alerts: [
      { id: 1, title: 'Stock bajo en arroz', severity: 'high', status: 'open', action_required: 'Reponer o generar compra', detail: 'Quedan pocas unidades contra minimo configurado.' },
    ...
    riskEvents: [
      ...
      { id: 2, title: 'Diferencia de stock', detail: 'Controlar conteo de panificados.', severity: 'low', source: 'inventario', status: 'open', created_at: nowIso() },
    ],
    fulfillmentOrders: [
      { id: 1, fulfillment_order_id: 'TN-1001', status: 'pending', customer_name: 'Cliente online demo', total_ars: 12500, created_at: nowIso(), items_count: 3 },
    ],
    storeCredits: [
